      ...
      <div class="relative isolate overflow-hidden">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
          <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
            ...
            <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">Detect Phishing in  the Web Application Now</h1>
            <p class="mt-6 text-lg leading-8 text-gray-300">Phishing detector is the platform helps people to define the web application is vulnerable or not.</p>
            <div class="mt-10 flex flex-col ">
              <!-- <nuxt-link to="/login" class="rounded-md w-fit bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">
                Get started
              </nuxt-link> -->
              <form class="mt-5 sm:flex sm:items-center">
                <div class="w-full sm:max-w-xs">
                  <input type="search" name="search" id="search" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Paste URL here" />
                </div>
                <nuxt-link to="/login" type="submit" class="mt-3 inline-flex w-full items-center justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:ml-3 sm:mt-0 sm:w-auto">Check Website</nuxt-link>
              </form>
            </div>
          </div>
